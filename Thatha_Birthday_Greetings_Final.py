...
cake.pencolor("RED")
cake.write("Happy Birthday Thatha", move=True, align="left", font=("Arial", 50, "normal"))

cake.pu()                #pen up
cake.goto(-50,-50)        #turtle go back
cake.pd()                #pen down

cake.write("8", move=True, align="left", font=("Arial", 70, "normal"))
cake.write("2", move=True, align="left", font=("Arial", 70, "normal"))
